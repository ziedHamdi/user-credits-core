...
/**
 * Represents an offer meta data when combined in a {@link ICombiningOffer} offer
 */
export interface ICombinedOffer<K extends IMinimalId> {
  ...
  /**
   * Triggers the engine to search if the user doesn't have the right to an overriding offer with more tokens or dates (the offer unlockedBy, overrdingKey, and weight are used to decide upon that)
   */
